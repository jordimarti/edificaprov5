...
class ChannelsTest < ApplicationSystemTestCase
  ...
  test "should create channel" do
    ...
    fill_in "Account", with: @channel.account_id
    fill_in "Main community", with: @channel.main_community
    fill_in "Name", with: @channel.name
    fill_in "Privacy", with: @channel.privacy
    fill_in "Subscribers", with: @channel.subscribers
