...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference("Community.count") do
      post communities_url, params: { community: { channel_id: @community.channel_id, name: @community.name, privacy: @community.privacy, publicid: @community.publicid } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { channel_id: @community.channel_id, name: @community.name, privacy: @community.privacy, publicid: @community.publicid } }
